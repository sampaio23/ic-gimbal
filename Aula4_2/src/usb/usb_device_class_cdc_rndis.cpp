...
uint8_t* USB_DEVICE_CLASS_CDC_RNDIS::GetDescriptor() {
	...
	_descriptor[19+14]=_inendpoints[0];

	_descriptor[26+14]=_interfaces[1];
	_descriptor[35+14]=_inendpoints[1];
	_descriptor[42+14]=_outendpoints[1];
