...
USB_DEVICE_CLASS_CDC_VCP::USB_DEVICE_CLASS_CDC_VCP(uint8_t enabled):
	USB_DEVICE_CLASS(2, 2, 2, {"TPP-1400 Serial Port"}, enabled),
	_datainbuffer(0,512),
	_dataoutbuffer(0,512),
	_sendzerolen(0),
	_USB_Tx_State(0),
	_USB_Rx_State(0),
...
uint8_t USB_DEVICE_CLASS_CDC_VCP::SOF() {
	if(!_USB_Tx_State && _datainbuffer.Ocupied()){
